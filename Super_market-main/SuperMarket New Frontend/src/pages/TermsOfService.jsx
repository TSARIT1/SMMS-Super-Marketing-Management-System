          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="flex items-center gap-3 p-4 bg-indigo-50 rounded-xl">
                ...
                <span className="font-semibold text-indigo-800">Legal Agreement</span>
              </div>
              <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-xl">
                <ShieldCheck className="text-purple-600" size={24} />
                <span className="font-semibold text-purple-800">Your Rights</span>
              </div>
              <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl">
                <AlertTriangle className="text-blue-600" size={24} />
                <span className="font-semibold text-blue-800">Responsibilities</span>
              </div>
            </div>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-600 leading-relaxed">
                By accessing and using TSAR IT SMMS, you accept and agree to be bound by the terms and provision of this agreement.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-600 leading-relaxed">
                Permission is granted to temporarily use TSAR IT SMMS for personal and business use, subject to restrictions stated in these terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-600 leading-relaxed">
                TSAR IT SMMS provides retail management software including billing, inventory, and analytics features for supermarket operations.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-600 leading-relaxed">
                Subscription fees are billed in advance and are non-refundable except as expressly stated in our refund policy.
              </p>
            </section>
